...
- (void)viewDidLoad {
    ...
    NSString *imageName = [[NSUserDefaults standardUserDefaults] objectForKey:kSelectedBgName];
    ...
    bgImageView.backgroundColor = kThemeColor;
